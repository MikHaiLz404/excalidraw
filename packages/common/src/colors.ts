...
export const COLOR_TOP_PICKS_SLOTS = 10;

// ORDER matters for positioning in quick picker
// Same shade level (open-color shade 8 / bronze shade 11) for visual parity.
export const DEFAULT_ELEMENT_STROKE_PICKS = [
  COLOR_PALETTE.white,
  COLOR_PALETTE.gray[DEFAULT_ELEMENT_STROKE_COLOR_INDEX],
  COLOR_PALETTE.black,
  COLOR_PALETTE.yellow[DEFAULT_ELEMENT_STROKE_COLOR_INDEX],
  COLOR_PALETTE.orange[DEFAULT_ELEMENT_STROKE_COLOR_INDEX],
  COLOR_PALETTE.red[DEFAULT_ELEMENT_STROKE_COLOR_INDEX],
  COLOR_PALETTE.bronze[DEFAULT_ELEMENT_STROKE_COLOR_INDEX],
...
export const DEFAULT_ELEMENT_BACKGROUND_PICKS = [
  ...
  COLOR_PALETTE.gray[DEFAULT_ELEMENT_BACKGROUND_COLOR_INDEX],
  COLOR_PALETTE.black,
  COLOR_PALETTE.yellow[DEFAULT_ELEMENT_BACKGROUND_COLOR_INDEX],
  COLOR_PALETTE.orange[DEFAULT_ELEMENT_BACKGROUND_COLOR_INDEX],
  COLOR_PALETTE.red[DEFAULT_ELEMENT_BACKGROUND_COLOR_INDEX],
  COLOR_PALETTE.bronze[DEFAULT_ELEMENT_BACKGROUND_COLOR_INDEX],
