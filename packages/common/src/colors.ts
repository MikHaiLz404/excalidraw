...
export const DEFAULT_ELEMENT_STROKE_PICKS = [
  ...
  COLOR_PALETTE.pink[DEFAULT_ELEMENT_STROKE_COLOR_INDEX],
] as const;
...
export const DEFAULT_ELEMENT_BACKGROUND_PICKS = [
  ...
  COLOR_PALETTE.grape[DEFAULT_ELEMENT_BACKGROUND_COLOR_INDEX],
  COLOR_PALETTE.pink[DEFAULT_ELEMENT_BACKGROUND_COLOR_INDEX],
] as const;
